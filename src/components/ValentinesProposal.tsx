      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations Srishti! You have completed the game.
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Himshrey has a surprise for you!
          </motion.h2>
        )}
        {step === 2 && (
          <motion.div
          ...
          >
            ...
            >
              Will you be my Valentine Srishti?
            </h2>
            <Image
              src="/sad_hamster.png"
              alt="Sad Hamster"
        ...
        {step === 3 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            Thank you for accepting, I love you Srishti! 💕
